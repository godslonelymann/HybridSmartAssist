...
class FloatingService : Service() {
    ...
    companion object {
        const val ACTION_LANGUAGE_CHANGED =
            "com.example.smartassist.ACTION_LANGUAGE_CHANGED"
    }
    ...
    override fun onDestroy() {
        try { unregisterReceiver(languageReceiver) } catch (_: Exception) {}
